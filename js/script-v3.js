...
function handleRadioButtonChange(radioButton) {
  ...
  totalDiscount.textContent = 'Sparen Sie ' + formatPrice(oldPrice - actualPrice);

  // update link for selected package
  if(Number(selectedPackage) === 3) {
    addToCartLink.href = 'https://swiss-power.de/cart/51391711936841:3';
    totalOldPrice.classList.remove('hide')
    totalDiscount.classList.remove('hide')
  } else if (Number(selectedPackage) === 1) {
    addToCartLink.href = 'https://swiss-power.de/cart/51391711936841:1';
    totalOldPrice.classList.remove('hide')
    totalDiscount.classList.remove('hide')
  } else {
    addToCartLink.href = 'https://swiss-power.de/cart/51391711936841:' + selectedPackage;
    totalOldPrice.classList.remove('hide')
    totalDiscount.classList.remove('hide')
  }
